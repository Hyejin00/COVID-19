  ...
  return (
    <View style={styles.svgContainer}>
      <Svg height="80%" width="80%" viewBox="0 0 130 204" {...props}>
        ...
        <G id="layer_1">
        <TouchableWithoutFeedback onPress={() => console.log('제주 Was Clicked')}>
        <Path 
            fill={stateColors.jeju}
            stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('경남 Was Clicked')}>
        <Path 
        fill={stateColors.gyoungnam}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('부산 Was Clicked')}>
        <Path 
        fill={stateColors.busan}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('울산 Was Clicked')}>
        <Path 
        fill={stateColors.ulsan}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('전남 Was Clicked')}>
        <Path 
        fill={stateColors.jeonnam}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('전북 Was Clicked')}>
        <Path 
        fill={stateColors.jeonbuk}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('충북 Was Clicked')}>
        <Path 
        fill={stateColors.chungbuk}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('충남 Was Clicked')}>
        <Path 
        fill={stateColors.chungnam}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('경북 Was Clicked')}>
        <Path 
        fill={stateColors.gyoungbuk}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('강원 Was Clicked')}>
        <Path 
        fill={stateColors.gangwon}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('대구 Was Clicked')}>
        <Path 
        fill={stateColors.daegu}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('경기 Was Clicked')}>
        <Path 
        fill={stateColors.gyounggi}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('대전 Was Clicked')}>
        <Path 
        fill={stateColors.daejeon}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('인천 Was Clicked')}>
        <Path 
        fill={stateColors.incheon}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('서울 Was Clicked')}>
        <Path 
        fill={stateColors.seoul}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('세종 Was Clicked')}>
        <Path 
        fill={stateColors.sejong}
        stroke={colors.map.maxColor}
        ...
        <TouchableWithoutFeedback onPress={() => console.log('광주 Was Clicked')}>
        <Path 
        fill={stateColors.gwangju}
        stroke={colors.map.maxColor}
